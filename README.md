...
## Security and Privacy Notes Before Public Release

Before making the repository public, please check that the following files are not committed:

- real API keys;
- private API endpoints;
- `.env` files;
- local credential files;
- prompt traces containing private information;
- large unnecessary intermediate outputs.
...
If you want to release selected processed results, place them in a separate directory such as `paper_results/` and document their origin.
